    ...
    it.each([
      ...
      [
        ...
        },
        {
          'user.id': '9841878',
          'user.type': 'u',
          'user.avatar': 'https://avatars.githubusercontent.com/u/9841878?v=4',
        },
      ],
      [
        'name',
      ...
      [
        ...
        {
          url: 'https://tc.doctolib.net/viewLog.html?buildId=594007&buildTypeId=Doctolib_CIrrusDoctolibTestLauncherMasterProduction',
        },
      ],
